...
# ===============================================================
# Hero KPI strip — 4 個關鍵數字 30 秒看完研究體量
# ===============================================================
st.subheader("📊 研究體量速覽")
...
st.caption(
    "**台股月頻多因子 long-only**，每月 12 號盤後決策、次一交易日收盤成交。"
...
📌 OHLCV 截斷到 as_of 當天收盤為止（盤後再平衡，當天量價已定 → 合法使用），
絕不取用 as_of 之後的資訊。回測從 cache 切片、live 從 TWSE / TPEX API 拿。
"""
        )
