...
**IC IR 天花板僅 ~0.37；4/8 因子 DSR 0.77~0.95，但 edge 偏薄**

→ 因子有真訊號，但零售月頻 long-only 的訊號強度本就有限
"""
    )
...
roadmap_items = [
    ...
    },
    {
        ...
        "pain": "4/8 因子單因子 DSR>0.5（最強 idio_vol_max 0.95），但 IC IR 天花板僅 ~0.37、組合後 edge 薄。**更根本的問題：公開的學術因子"
